    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <form method="post" action="index.php?page=categories&action=edit&code=<?= urlencode($categorie['CodeCat'] ?? '') ?>">
                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                    <input type="hidden" name="CodeCat"    value="<?= htmlspecialchars($categorie['CodeCat'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">رمز الفئة</label>
                            <input type="text" class="form-control" readonly
                                   value="<?= htmlspecialchars($categorie['CodeCat'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                        </div>
                        <div class="col-md-8">
                            ...
                            <input type="text" name="LibCat" class="form-control"
                                   value="<?= htmlspecialchars($categorie['LibCat'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
